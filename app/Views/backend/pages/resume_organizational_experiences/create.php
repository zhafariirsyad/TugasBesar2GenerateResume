...
<section class="section">
    <div class="section-header">
        <h1>Create Organization Experience</h1>
    </div>
    <div class="row">
        <div class="col-12">
            <div class="card">
                <div class="card-body">
                    <form action="/internal/resume_organizational_experiences/store" method="post">
                        <?= csrf_field(); ?>
                        <div class="row">
                            <div class="col-12">
                        ...
                        <div class="form-group row mt-5">
                            ...
                            <div class="col-sm-10">
                                <input type="text" name="organization_name" class="form-control <?= ($validation->hasError('organization_name')) ? 'is-invalid' : '' ?>" id="organization_name" value="<?= old('organization_name') ?>" placeholder="Organization Name">
                                <div class="invalid-feedback font-size-invalid-feedback">
